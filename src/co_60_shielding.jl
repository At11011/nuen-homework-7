...
# Lead shielding
function lead_shielding(data_interpolations) 
    ...
    r_surf = 3u"mm" # Radius of bare source
    r_steel = 2u"mm" # Thickness of steel source casing
    r_air = 6u"sinch_us" # Airgap between source and walls of chamber 
    r_lead = 10u"sinch_us" # Thickness of lead chamber wall
    Co_60_act = 3000u"37GBq"
    ...
    exposure = uconvert(u"mSv/yr",  IₜBR)
